...
class LoginView extends Component 
{
  ...
  registerSubmit(e) {
    ...
    const { registerfirstName,registerlastName,registerusername, registerEmail, registerPassword } = this.state;
    const { dispatch } = this.props;
    if (registerEmail && registerPassword && registerlastName && registerfirstName) 
    {
      dispatch(userActions.register( registerfirstName, registerlastName,registerusername, registerEmail, registerPassword));
    }
  }

  render() {
    const { loggingIn } = this.props;
    const { loginEmail, loginPassword, loginSubmitted,registerfirstName,registerlastName, registerEmail, registerPassword, registerSubmitted, registerusername } = this.state;
    return (
                    ...
                    <form onSubmit={this.registerSubmit}>
                      <div className="form-row">
                        <div className="form-group col-md-12">
                          <input type="text" name="registerfirstName" className="form-control" value={registerfirstName} onChange={this.formChange} placeholder="Enter firstName" autoComplete="" required/>
                        </div>
                        <div className="form-group col-md-12">
                          <input type="text" name="registerlastName" className="form-control" value={registerlastName} onChange={this.formChange} placeholder="Enter lastName" autoComplete="" required/>
                        </div>
                        <div className="form-group col-md-12">
